...
export default function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f4efe6] text-[#4a4237]">
      {/* Top Dispatch Notification Bar */}
      <div className="bg-[#2c1608] text-[#fdfbf7] text-[11px] sm:text-xs py-2 px-4 text-center font-normal tracking-normal">
      ...
      {/* Header Navigation: Warm Parchment Background */}
      <header className="sticky top-0 z-40 bg-[#f4efe6]/95 backdrop-blur-md border-b border-[#dcd4c5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          <div className="flex flex-col">
            <span className="font-serif text-lg sm:text-2xl font-bold text-[#1e1915] tracking-tight">
              DHENIG LEATHER
            </span>
            <span className="text-[9px] sm:text-[10px] tracking-wider uppercase text-[#9a480e] font-semibold">
              Jakarta, Indonesia (Established 1997)
            </span>
          </div>

          <nav className="hidden lg:flex items-center space-x-8 text-xs sm:text-sm font-medium text-[#4a4237]">
            <a href="#about" className="hover:text-[#6b3310] transition-colors">About Us</a>
            <a href="#collection" className="hover:text-[#6b3310] transition-colors">Leather Catalog</a>
            <a href="#ordering" className="hover:text-[#6b3310] transition-colors">How to Order</a>
            <a href="#location" className="hover:text-[#6b3310] transition-colors">Store Location</a>
          </nav>
          ...
          <div className="flex items-center">
            <a
              ...
              className="inline-flex items-center space-x-1.5 bg-[#6b3310] hover:bg-[#4d2309] text-white text-xs font-medium px-4 py-2 rounded-md transition-colors shadow-xs"
            >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 md:py-32">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a
                href="#collection"
                className="w-full sm:w-auto text-center bg-[#6b3310] hover:bg-[#854015] text-white font-medium text-xs sm:text-sm px-6 py-3 rounded-md transition-colors shadow-xs"
              >
                View Current Stock
              </a>
              <a
            ...
            {/* Factual Metrics */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-12 pt-8 border-t border-white/20 text-left">
              <div>
      ...
      {/* About & Sourcing Practices: Warm Sandstone Surface */}
      <section id="about" className="py-16 sm:py-20 bg-[#eae3d5] border-b border-[#dcd4c5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center mb-12 sm:mb-16">
            <span className="text-xs uppercase tracking-wider text-[#9a480e] font-semibold">Store Background</span>
            <h2 className="font-serif text-2xl sm:text-3xl font-bold text-[#1e1915] mt-1 mb-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="p-6 rounded-xl bg-[#fdfbf7] border border-[#dcd4c5] shadow-xs">
              <ShieldCheck className="w-8 h-8 text-[#6b3310] mb-4" />
              <h3 className="font-serif font-bold text-base sm:text-lg text-[#1e1915] mb-2">Real Leather Only</h3>
            ...
            <div className="p-6 rounded-xl bg-[#fdfbf7] border border-[#dcd4c5] shadow-xs">
              <Award className="w-8 h-8 text-[#6b3310] mb-4" />
              <h3 className="font-serif font-bold text-base sm:text-lg text-[#1e1915] mb-2">Store Since 1997</h3>
              <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed">
            ...
            <div className="p-6 rounded-xl bg-[#fdfbf7] border border-[#dcd4c5] shadow-xs">
              <Globe2 className="w-8 h-8 text-[#6b3310] mb-4" />
              <h3 className="font-serif font-bold text-base sm:text-lg text-[#1e1915] mb-2">Domestic and Italian Sourcing</h3>
              <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed">
            ...
            <div className="p-6 rounded-xl bg-[#fdfbf7] border border-[#dcd4c5] shadow-xs">
              <Scissors className="w-8 h-8 text-[#6b3310] mb-4" />
              <h3 className="font-serif font-bold text-base sm:text-lg text-[#1e1915] mb-2">Flexible Quantities</h3>
              <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed">
      ...
      <section id="ordering" className="py-16 sm:py-20 bg-[#eae3d5] border-b border-[#dcd4c5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center mb-12 sm:mb-16">
            <span className="text-xs uppercase tracking-wider text-[#9a480e] font-semibold">How to Order</span>
            <h2 className="font-serif text-2xl sm:text-3xl font-bold text-[#1e1915] mt-1 mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="p-6 sm:p-8 rounded-xl bg-[#fdfbf7] border border-[#dcd4c5] shadow-xs">
              <div className="w-8 h-8 rounded-full bg-[#6b3310] text-white flex items-center justify-center font-bold text-xs mb-4">
                1
              </div>
              <h3 className="font-serif font-bold text-base sm:text-lg text-[#1e1915] mb-2">Check Specifications</h3>
              <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed">
            ...
            <div className="p-6 sm:p-8 rounded-xl bg-[#fdfbf7] border border-[#dcd4c5] shadow-xs">
              ...
              <h3 className="font-serif font-bold text-base sm:text-lg text-[#1e1915] mb-2">Review Photos and Video</h3>
              <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed">
            ...
            <div className="p-6 sm:p-8 rounded-xl bg-[#fdfbf7] border border-[#dcd4c5] shadow-xs">
              ...
              <h3 className="font-serif font-bold text-base sm:text-lg text-[#1e1915] mb-2">Packaging and Dispatch</h3>
              <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed">
      ...
      <section id="location" className="py-16 sm:py-20 bg-[#f4efe6] border-b border-[#dcd4c5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#fdfbf7] border border-[#dcd4c5] rounded-2xl overflow-hidden shadow-xs">
            <div className="grid grid-cols-1 lg:grid-cols-12">
              {/* Left Column: Store Details */}
              <div className="lg:col-span-7 p-6 sm:p-10 md:p-12">
                <span className="text-xs uppercase tracking-wider text-[#9a480e] font-semibold">Store and Warehouse</span>
                <h2 className="font-serif text-2xl sm:text-3xl font-bold text-[#1e1915] mt-1 mb-4">
                  Visit Toko Kulit Dhenig
                </h2>
                <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed mb-6">
                  You are welcome to come and handle the leather in person. We have parking available in the Harco Mangga Dua complex.
                </p>

                <div className="space-y-3.5 text-xs sm:text-sm text-[#4a4237] mb-8">
                  <div className="flex items-start space-x-3">
                    <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-[#6b3310] shrink-0 mt-0.5" />
                    <div>
                      <strong className="text-[#1e1915] block">Toko Kulit Dhenig</strong>
                  ...
                  <div className="flex items-center space-x-3">
                    <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-[#6b3310] shrink-0" />
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-center bg-[#6b3310] hover:bg-[#4d2309] text-white text-xs font-medium px-5 py-3 rounded-md transition-colors inline-flex items-center justify-center space-x-2 shadow-xs"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-center bg-[#fdfbf7] hover:bg-[#eae3d5] text-[#1e1915] border border-[#dcd4c5] text-xs font-medium px-5 py-3 rounded-md transition-colors inline-flex items-center justify-center space-x-2"
                  >
      ...
      {/* Footer */}
      <footer className="bg-[#1e1915] text-stone-400 py-12 sm:py-16 text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 pb-8 border-b border-[#38302a]">
            <div>
          ...
          <div className="pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 text-[11px] text-stone-400">
            <p>&copy; {new Date().getFullYear()} Toko Kulit Dhenig. Established 1997.</p>
            <p>
              Website crafted by <a href="mailto:andre4freelance@gmail.com" className="text-amber-300 hover:underline">andre4freelance@gmail.com</a>
            </p>
          </div>
        </div>
      </footer>
